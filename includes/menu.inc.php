...
Class Menu {
    ...
    public static function getMenu($sItems) {
        ...
        foreach(self::$menu as $menuindex => $menuitem)       
        {
            ...
            { $submenu .= "<li class=\"nav-item dropdown\"><a class=\"nav-link\" href='".SITE_ROOT.$sItems[0]."/".$menuindex."' ".($menuindex==$sItems[1]? "class='active'":"").">".$menuitem[0]."</a></li>"; 
        ...
        if($submenu != "")
            $submenu = "<ul class=\"navbar-nav me-auto mb-2 mb-lg-0 dropdown-item\">".$submenu."</ul>";
